...
<section>
    <div style="background-image: url('img/2.jpg'); background-repeat: no-repeat; background-size: cover;">
        ...
        <div class="full-bg-img flex-center white-text hm-black-slight">
            <ul class="animated fadeIn col-md-12 list-unstyled">
                <li>
                    <h1 class="h1-responsive font-weight-bold wow animated fadeInDown mt-5 pt-5"  data-wow-delay="0.5s">FREQUENTLY ASKED QUESTIONS</h1>
                </li>
            </ul>
        </div>
        <!-- /.Caption -->
  ...
  <main>
    ...
    <div class="container">
      ...
      <!--Section: Pricing v.5-->
      <section class="section team-section pb-5 pt-1">
          ...
          <div class="col-md-10 col-xl-10 pb-5 pt-3">
            ...
            <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
              ...
              <div class="card border-0">
                ...
                <!-- Card header -->
                <div class="card-header white z-depth-1 border-0 mb-1" role="tab" id="heading4">
                ...
                <div id="collapse4" class="collapse" role="tabpanel" aria-labelledby="heading4" data-parent="#accordionEx">
                  <div class="card-body mb-1 rgba-indigo-strong white-text">
                    <p>The project starts with a 50% deposit. After design sign off and before we move into programming,
                     we collect 25%. Once we have completed and fulfilled our scope, the final 25% is collected and your website is then scheduled for launch.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="card border-0">
                ...
                <!-- Card header -->
                <div class="card-header white z-depth-1 border-0 mb-1" role="tab" id="heading5">
                ...
                <div id="collapse5" class="collapse" role="tabpanel" aria-labelledby="heading5" data-parent="#accordionEx">
                  <div class="card-body mb-1 rgba-indigo-strong white-text">
                    <p>Our standard websites take approximately 90 days to create. 
                    Our E-commerce (online store) websites take approximately 120 days to create. 
                    This time will vary from project to project.</p>
                  </div>
                </div>
              </div>
              <!-- Accordion card -->
              ...
              <div class="card border-0">
                ...
                <!-- Card header -->
                <div class="card-header white z-depth-1 border-0 mb-1" role="tab" id="heading6">
                  <a data-toggle="collapse" data-parent="#accordionEx" href="#collapse6" aria-expanded="true"
                    aria-controls="collapse6">
                    <h5 class="mb-0 dark-grey-text">
                      #6 Can you help me write content for my website?
                      <i class="fa fa-angle-down rotate-icon"></i>
                    </h5>
                  </a>
                </div>
                ...
                <div id="collapse6" class="collapse" role="tabpanel" aria-labelledby="heading6" data-parent="#accordionEx">
                  <div class="card-body mb-1 rgba-indigo-strong white-text">
                    <p>While I do not provide direct copy writing services beyond basic site content, I can definitely direct you to some excellent and experienced copy writers who do great content production.</p>
                  </div>
                </div>
              </div>
              <!-- Accordion card -->
              ...
              <div class="card border-0">
                ...
                <!-- Card header -->
                <div class="card-header white z-depth-1 border-0 mb-1" role="tab" id="heading7">
                  <a data-toggle="collapse" data-parent="#accordionEx" href="#collapse7" aria-expanded="true"
                    aria-controls="collapse7">
                    <h5 class="mb-0 dark-grey-text">
                      #7 How often will you keep in touch?
                      <i class="fa fa-angle-down rotate-icon"></i>
                    </h5>
                  </a>
                </div>
              ...
              <div class="card border-0">
                ...
                <!-- Card header -->
                <div class="card-header white z-depth-1 border-0 mb-1" role="tab" id="heading8">
