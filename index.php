...
<!-- Intro Section -->
<div id="home" class="view jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url('img/christmas.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
                                        ...
                                        <div class="col-md-12">
                                            <div class="md-form">
                                                <div class="md-form">
                                                    ...
                                                    <button type="submit" class="btn-floating btn-lg green" onclick="validateform()"><i class="fas fa-paper-plane"></i></button>
                                                </div>
