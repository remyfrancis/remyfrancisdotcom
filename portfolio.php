        ...
        <section class="text-center pb-3">
                ...
                <div class="row">
                    ...
                    <div class="card card-cascade wider reverse py-5">
                        ...
                        <img class="card-img-top" src="img/portfolio_images/partly-cloudy.png" alt="Partly Cloudy Scattered Showers">
                        <a href="#!">
                        ...
                        <!-- Title -->
                        <h4 class="card-title"><strong>Partly Cloudy Scattered Showers</strong></h4>
                        <!-- Subtitle -->
                    ...
                    <div class="card card-cascade wider reverse py-5">
                            ...
                            <!-- Card image -->
                            <div class="view view-cascade overlay">
                            <img class="card-img-top" src="img/portfolio_images/kickstart.PNG" alt="KickStart Driving & Riding School">
                            <a href="#!">
                                <div class="mask rgba-white-slight"></div>
                            </a>
                            </div>
                            ...
                            <!-- Title -->
                            <h4 class="card-title"><strong>KickStart Driving & Riding School</strong></h4>
                            <!-- Subtitle -->
                    ...
                    <div class="card card-cascade wider reverse py-5">
                        ...
                        <!-- Card image -->
                        <div class="view view-cascade overlay">
                        <img class="card-img-top" src="img/portfolio_images/advantage.png" alt="Advantage Real Estate">
                        <a href="#!">
                            <div class="mask rgba-white-slight"></div>
                        </a>
                        </div>
                        ...
                        <!-- Title -->
                        <h4 class="card-title"><strong>Advantage Real Estate</strong></h4>
                        <!-- Subtitle -->
                    ...
                    <div class="card card-cascade wider reverse">
                        ...
                        <!-- Card image -->
                        <div class="view view-cascade overlay">
                        <img class="card-img-top" src="img/portfolio_images/iwn.png" alt="Island Wide News">
                        <a href="#!">
                            <div class="mask rgba-white-slight"></div>
                        </a>
                        </div>
                        ...
                        <!-- Title -->
                        <h4 class="card-title"><strong>Island Wide News</strong></h4>
                        <!-- Subtitle -->
