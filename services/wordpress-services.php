        ...
        <div style="background-image: url('https://mdbootstrap.com/img/Photos/Others/slide4.jpg'); background-repeat: no-repeat; background-size: cover;">
            ...
            <div class="full-bg-img  flex-center white-text rgba-stylish-strong">
                <ul class="animated fadeIn col-md-12 list-unstyled">
                    <li>
                        <h1 class="display-4 font-weight-bold mt-5 pt-5 ">WORDPRESS SERVICES</h1>
                    </li>
                </ul>
            </div>
            <!-- /.Caption -->
        ...
        <div class="container">
            ...
            <section class="mt-5 mb-5 py-3 wow fadeIn" data-wow-delay="0.2s">
                ...
                <ul class="list-unstyled nav md-pills nav-justified pills-black">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#premium-wp-themes" role="tab">Premium Theme Installation</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#wp-customization" role="tab">Theme Customization</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#wp-maintenance" role="tab">Maintenance Service</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#wp-security" role="tab">WordPress Security</a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <!--Panel 1-->
                    <div class="tab-pane fade in show active" id="premium-wp-themes" role="tabpanel">
                        <br>
                    ...
                    <!--Panel 2-->
                    <div class="tab-pane fade" id="wp-customization" role="tabpanel">
                        <br>
                    ...
                    <!--Panel 3-->
                    <div class="tab-pane fade" id="wp-maintenance" role="tabpanel">
                        <br>
                    ...
                    <!--Panel 4-->
                    <div class="tab-pane fade" id="wp-security" role="tabpanel">
                        <br>
                        <!-- Grid row -->
                        <div class="row pt-2 mt-lg-5">
